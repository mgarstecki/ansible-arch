...
local bookwark_widget = require("autorandr")
...
beautiful.wallpaper = "/usr/share/pixmaps/IMG_6364_cropped.JPG"
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "bottom", screen = s, height = 21 })
